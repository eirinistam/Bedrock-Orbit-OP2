...
agent_alias_id = os.environ.get("BEDROCK_AGENT_ALIAS_ID", "75AGHOAP7W")
ui_title = os.environ.get("BEDROCK_AGENT_TEST_UI_TITLE", "Orbit OP2 2024")
...
st.sidebar.image("GenAIIconLarge.png")
st.title(ui_title)
